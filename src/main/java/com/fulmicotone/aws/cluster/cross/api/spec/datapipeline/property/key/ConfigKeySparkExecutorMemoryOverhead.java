...
public class ConfigKeySparkExecutorMemoryOverhead extends MyString implements IPropertyKey {


    public ConfigKeySparkExecutorMemoryOverhead() { super("spark.executor.memoryOverhead"); }
}

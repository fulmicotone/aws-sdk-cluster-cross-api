...
public class ConfigValueDynamicAllocationMaxExecutorsPH extends MyStringPlaceHolder implements IPropertyValue {
    @Override
    protected ParamsKeys placeHolderVal() {
        return ParamsKeys.myEmrConfigDynamicAllocationMaxExecutors;
    }
}
